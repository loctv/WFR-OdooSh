...
class DynamicBarcodeStockLabelsParser(models.AbstractModel):
    _name = 'report.bi_dynamic_barcode_labels.stock_dynamic_barcode_labels'
    ...
    def _get_report_values(self, docids, data=None):
        barcode_labels_report = self.env['ir.actions.report']._get_report_from_name('bi_dynamic_barcode_labels.stock_dynamic_barcode_labels')
